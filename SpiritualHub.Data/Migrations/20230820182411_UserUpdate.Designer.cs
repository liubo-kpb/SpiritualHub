...
namespace SpiritualHub.Data.Migrations
{
    ...
    [Migration("20230820182411_UserUpdate")]
            ...
            modelBuilder.Entity("SpiritualHub.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "9e570b57-be0a-4b8e-9d62-28c338082152",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEO3hIGKJNck51rrys1y/NSso++p8dzEeVA05YIB6rn8AuRZvGWa0CiHlSwJQ5CSomA==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "e73d63bf-de52-424d-81ae-4477bb789396",
                            Email = "user@mail.com",
                            EmailConfirmed = false,
                            FirstName = "Martin",
                            LastName = "User",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEOw8erVJB2RD+Rrf17S3yXXM2IaIkV9wjMf/A1FhN9VDTyMyFCL9z577In68Z8+SFg==",
                            PhoneNumberConfirmed = false,
                            TwoFactorEnabled = false,
                            UserName = "user"
                        });
            ...
            modelBuilder.Entity("SpiritualHub.Data.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryID = 2,
                            CreatedOn = new DateTime(2023, 8, 20, 18, 24, 10, 852, DateTimeKind.Utc).AddTicks(1577),
                        ...
                        new
                        {
                            ...
                            CategoryID = 5,
                            CreatedOn = new DateTime(2023, 8, 20, 18, 24, 10, 852, DateTimeKind.Utc).AddTicks(1599),
                        ...
                        new
                        {
                            ...
                            CategoryID = 3,
                            CreatedOn = new DateTime(2023, 8, 20, 18, 24, 10, 852, DateTimeKind.Utc).AddTicks(2046),
            ...
            modelBuilder.Entity("SpiritualHub.Data.Models.Subscription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("83c655d9-9b2a-42ce-ab1b-81bd67a31f10"),
                            AuthorID = new Guid("8c8bd426-2974-4bad-aa33-0e045ca86a54"),
                            Price = 25m,
                        ...
                        new
                        {
                            Id = new Guid("8581b9a3-6e82-4f99-851a-3d388ec28679"),
                            AuthorID = new Guid("8c8bd426-2974-4bad-aa33-0e045ca86a54"),
                            Price = 65m,
                        ...
                        new
                        {
                            Id = new Guid("407a6d7c-32ba-42d2-98b3-662f66f142e0"),
                            AuthorID = new Guid("8c8bd426-2974-4bad-aa33-0e045ca86a54"),
                            Price = 150m,
                        ...
                        new
                        {
                            Id = new Guid("8735a14e-8c11-4b92-8979-cbc5fb90c152"),
                            AuthorID = new Guid("47383fe7-f3e1-4d22-8180-5bfaa76955f5"),
                            Price = 25m,
                            SubscriptionTypeID = 1
                        },
                        new
                        {
                            Id = new Guid("15770521-ffc1-42eb-9111-9bb378a119a7"),
                            AuthorID = new Guid("47383fe7-f3e1-4d22-8180-5bfaa76955f5"),
                            Price = 70m,
                            SubscriptionTypeID = 2
                        },
                        new
                        {
                            Id = new Guid("6d50b6a2-bf88-40eb-80c2-81943f4933d9"),
                            AuthorID = new Guid("47383fe7-f3e1-4d22-8180-5bfaa76955f5"),
                            Price = 200m,
                            SubscriptionTypeID = 3
                        },
                        new
                        {
                            Id = new Guid("7f3999e0-d890-45af-854b-5c077748a898"),
                            AuthorID = new Guid("240ae09a-7f04-45e5-ac42-bf5311e1c4a8"),
                            Price = 21m,
                            SubscriptionTypeID = 1
                        },
                        new
                        {
                            Id = new Guid("449f3772-8c64-448e-a637-78b3da1058fa"),
                            AuthorID = new Guid("240ae09a-7f04-45e5-ac42-bf5311e1c4a8"),
                            Price = 55m,
                            SubscriptionTypeID = 2
                        },
                        new
                        {
                            Id = new Guid("7336f957-e89c-4b53-9a46-d50e4fd7620c"),
                            AuthorID = new Guid("240ae09a-7f04-45e5-ac42-bf5311e1c4a8"),
                            Price = 189m,
                            SubscriptionTypeID = 3
                        });
