...
namespace SpiritualHub.Data.Migrations
{
    ...
    [Migration("20230918081449_FixUserBookUserCourseFKs")]
    partial class FixUserBookUserCourseFKs
    {
            ...
            modelBuilder.Entity("SpiritualHub.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b006aaef-4a2f-4a30-8018-d52b1138c62b",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEIbCdHOdfdAZLdHC0/KSjSXUBb3/Aq9hnTJI9SQkgS03rsWezquqxGd27S5eDm98zQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "83c5bcef-d1ca-43fa-bdc1-b1593d63a4c7",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "9618370a-69e8-4f5c-926e-5f5ee2df3dd7",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAELPRGOGCB+mH1O17I/p+REf5R43sSv3/egjaA31zbKzQXYxmL4Od0S19ngncI7sFQg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "a1e87dfe-fd79-45dc-8a79-22251494801c",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3f56b8f1-b02f-4560-ac24-66e2a3930820",
                            Email = "user@mail.com",
                            EmailConfirmed = false,
                            FirstName = "Martin",
                            LastName = "User",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEGvnNzde5g0wCoV3KChh99WZPtLBwy5fm1auOgN3nHWKTzTkW5QmWEbcBS7ISn9zOg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "d4c079bc-881d-49e0-95bb-23c154128bac",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b55b0670-4d9e-4464-882d-988d0621d482",
                            Email = "noname@mail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "NONAME@MAIL.COM",
                            NormalizedUserName = "NONAME@MAIL.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEPlF/S0mZhTC7XOaMUiiZdKTbZ+knSkdeLL5W34OhEomgjpa0gQJz9OXQpgE2M4lKw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "bc07e234-dbaa-4483-9ebd-ce978d466b5c",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("SpiritualHub.Data.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AuthorID = new Guid("47383fe7-f3e1-4d22-8180-5bfaa76955f5"),
                            CategoryID = 2,
                            CreatedOn = new DateTime(2023, 9, 18, 8, 14, 45, 550, DateTimeKind.Utc).AddTicks(1924),
                        ...
                        new
                        {
                            ...
                            AuthorID = new Guid("8c8bd426-2974-4bad-aa33-0e045ca86a54"),
                            CategoryID = 5,
                            CreatedOn = new DateTime(2023, 9, 18, 8, 14, 45, 550, DateTimeKind.Utc).AddTicks(2010),
                        ...
                        new
                        {
                            ...
                            AuthorID = new Guid("240ae09a-7f04-45e5-ac42-bf5311e1c4a8"),
                            CategoryID = 3,
                            CreatedOn = new DateTime(2023, 9, 18, 8, 14, 45, 550, DateTimeKind.Utc).AddTicks(2216),
            ...
            modelBuilder.Entity("SpiritualHub.Data.Models.Subscription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("44d15e3c-3655-4dac-9351-adf22596297e"),
                            AuthorID = new Guid("8c8bd426-2974-4bad-aa33-0e045ca86a54"),
                            Price = 25m,
                        ...
                        new
                        {
                            Id = new Guid("6eeb1155-7b95-4123-8b13-ec5f8a2d8c6d"),
                            AuthorID = new Guid("8c8bd426-2974-4bad-aa33-0e045ca86a54"),
                            Price = 65m,
                        ...
                        new
                        {
                            Id = new Guid("e9db03c7-3a1f-4169-b17b-c26d6798de4c"),
                            AuthorID = new Guid("8c8bd426-2974-4bad-aa33-0e045ca86a54"),
                            Price = 150m,
                        ...
                        new
                        {
                            Id = new Guid("a45531de-8abf-431e-8834-af613f3c626a"),
                            AuthorID = new Guid("47383fe7-f3e1-4d22-8180-5bfaa76955f5"),
                            Price = 25m,
                            SubscriptionTypeID = 1
                        },
                        new
                        {
                            Id = new Guid("d70eb15c-4179-48ca-8b85-6f194028b0c0"),
                            AuthorID = new Guid("47383fe7-f3e1-4d22-8180-5bfaa76955f5"),
                            Price = 70m,
                            SubscriptionTypeID = 2
                        },
                        new
                        {
                            Id = new Guid("9ddb8474-ce6c-4375-99bd-fd3d0f2614e4"),
                            AuthorID = new Guid("47383fe7-f3e1-4d22-8180-5bfaa76955f5"),
                            Price = 200m,
                            SubscriptionTypeID = 3
                        },
                        new
                        {
                            Id = new Guid("b359ed3c-faca-465f-b274-a57b6054a422"),
                            AuthorID = new Guid("240ae09a-7f04-45e5-ac42-bf5311e1c4a8"),
                            Price = 21m,
                            SubscriptionTypeID = 1
                        },
                        new
                        {
                            Id = new Guid("34fc3be5-8970-445a-8177-17869599276e"),
                            AuthorID = new Guid("240ae09a-7f04-45e5-ac42-bf5311e1c4a8"),
                            Price = 55m,
                            SubscriptionTypeID = 2
                        },
                        new
                        {
                            Id = new Guid("71503ce1-a4bd-47cc-b9f4-aec5c6ee8b59"),
                            AuthorID = new Guid("240ae09a-7f04-45e5-ac42-bf5311e1c4a8"),
                            Price = 189m,
                            SubscriptionTypeID = 3
                        });
