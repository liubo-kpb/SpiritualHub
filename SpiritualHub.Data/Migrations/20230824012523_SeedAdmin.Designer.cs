...
namespace SpiritualHub.Data.Migrations
{
    ...
    [Migration("20230824012523_SeedAdmin")]
            ...
            modelBuilder.Entity("SpiritualHub.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "10429995-c696-41fd-a05e-255e2b5fa0ec",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEDqBvFOogyDTqh9TWvpB0Quykj8MY4CKNBMc2Lr2CK+lON8epBs84nj94XU4H92Bzw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "89b4836e-940d-456d-9233-25bb516e76ef",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b006360a-5652-4476-9631-69ecb559e7b1",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEL1QtpZdql9PqPeGVCIOTdL/v2GBy3aTMN75QM2lhBJN6GJOsz5fTaS5hFQ7hPydwA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "9b3c2066-fe40-4458-aa45-7add1ed8eb1b",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "07a62c31-f623-4ea4-8fc3-7e563b7d3ce4",
                            Email = "user@mail.com",
                            EmailConfirmed = false,
                            FirstName = "Martin",
                            LastName = "User",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEIErNcGRnjCVQMIX/disHNlRimlGqGF15oNG7m4XsDfwzIrIbpBn8MW21whhqPRIpg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "7e04ad78-b0c1-42df-ab68-acab872b4e06",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("SpiritualHub.Data.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryID = 2,
                            CreatedOn = new DateTime(2023, 8, 24, 1, 25, 22, 137, DateTimeKind.Utc).AddTicks(6881),
                        ...
                        new
                        {
                            ...
                            CategoryID = 5,
                            CreatedOn = new DateTime(2023, 8, 24, 1, 25, 22, 137, DateTimeKind.Utc).AddTicks(6894),
                        ...
                        new
                        {
                            ...
                            CategoryID = 3,
                            CreatedOn = new DateTime(2023, 8, 24, 1, 25, 22, 137, DateTimeKind.Utc).AddTicks(6902),
            ...
            modelBuilder.Entity("SpiritualHub.Data.Models.Subscription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a2c29123-be00-4658-b132-05c019569efa"),
                            AuthorID = new Guid("8c8bd426-2974-4bad-aa33-0e045ca86a54"),
                            Price = 25m,
                        ...
                        new
                        {
                            Id = new Guid("2b87c2c7-1889-4ca0-97d9-0200dc07cf11"),
                            AuthorID = new Guid("8c8bd426-2974-4bad-aa33-0e045ca86a54"),
                            Price = 65m,
                        ...
                        new
                        {
                            Id = new Guid("a3e2d8ac-d38c-4abf-b0d9-237dad108456"),
                            AuthorID = new Guid("8c8bd426-2974-4bad-aa33-0e045ca86a54"),
                            Price = 150m,
                        ...
                        new
                        {
                            Id = new Guid("6e1eeec9-72d9-48f9-8023-a44dc3435ad3"),
                            AuthorID = new Guid("47383fe7-f3e1-4d22-8180-5bfaa76955f5"),
                            Price = 25m,
                            SubscriptionTypeID = 1
                        },
                        new
                        {
                            Id = new Guid("1de5bc3f-ff9e-48c8-a65c-0b4f01f9a4e5"),
                            AuthorID = new Guid("47383fe7-f3e1-4d22-8180-5bfaa76955f5"),
                            Price = 70m,
                            SubscriptionTypeID = 2
                        },
                        new
                        {
                            Id = new Guid("048bff7c-4c39-43b1-8765-d276e4b4b4ab"),
                            AuthorID = new Guid("47383fe7-f3e1-4d22-8180-5bfaa76955f5"),
                            Price = 200m,
                            SubscriptionTypeID = 3
                        },
                        new
                        {
                            Id = new Guid("b31a05ce-0af3-4490-8ae5-ac8c6686afa7"),
                            AuthorID = new Guid("240ae09a-7f04-45e5-ac42-bf5311e1c4a8"),
                            Price = 21m,
                            SubscriptionTypeID = 1
                        },
                        new
                        {
                            Id = new Guid("d5dafb2e-2c58-449a-9ffa-c6985049eb28"),
                            AuthorID = new Guid("240ae09a-7f04-45e5-ac42-bf5311e1c4a8"),
                            Price = 55m,
                            SubscriptionTypeID = 2
                        },
                        new
                        {
                            Id = new Guid("7ec4d45d-0d7b-4be9-8793-af7e66a8f44c"),
                            AuthorID = new Guid("240ae09a-7f04-45e5-ac42-bf5311e1c4a8"),
                            Price = 189m,
                            SubscriptionTypeID = 3
                        });
