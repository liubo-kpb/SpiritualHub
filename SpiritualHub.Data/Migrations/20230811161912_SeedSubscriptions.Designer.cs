...
namespace SpiritualHub.Data.Migrations
{
    ...
    [Migration("20230811161912_SeedSubscriptions")]
    partial class SeedSubscriptions
    {
            ...
            modelBuilder.Entity("SpiritualHub.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "ece2c2cc-a4a7-47ec-8e21-7657253bc3b8",
                            Email = "publisher@spirits.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "PUBLISHER@SPIRITS.COM",
                            NormalizedUserName = "PUBLISHER",
                            PasswordHash = "AQAAAAEAACcQAAAAEOoPNjfzyK3tYJfEp6SHRKIorMgDZWPXksQ/AMctd6r4MwQKy/wJqgQWcBNYDoZeNg==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "61ad940d-3cac-4912-910d-bfffe6324b95",
                            Email = "user@mail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "USER@MAIL.COM",
                            NormalizedUserName = "USER",
                            PasswordHash = "AQAAAAEAACcQAAAAELbQ3BjMM/Krn6i9baTvjhaB32pZwCzdNRZ3xEsIpwhm6PQPFfYOXOkCn5Z8TeSpLA==",
                            PhoneNumberConfirmed = false,
                            TwoFactorEnabled = false,
                            UserName = "user"
                        });
            ...
            modelBuilder.Entity("SpiritualHub.Data.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryID = 2,
                            CreatedOn = new DateTime(2023, 8, 11, 16, 19, 11, 153, DateTimeKind.Utc).AddTicks(2225),
                        ...
                        new
                        {
                            ...
                            CategoryID = 5,
                            CreatedOn = new DateTime(2023, 8, 11, 16, 19, 11, 153, DateTimeKind.Utc).AddTicks(2266),
                        ...
                        new
                        {
                            ...
                            CategoryID = 3,
                            CreatedOn = new DateTime(2023, 8, 11, 16, 19, 11, 153, DateTimeKind.Utc).AddTicks(2279),
            ...
            modelBuilder.Entity("SpiritualHub.Data.Models.Subscription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("bea5249f-f2ee-40b0-b0d3-83d5b7161c19"),
                            AuthorID = new Guid("8c8bd426-2974-4bad-aa33-0e045ca86a54"),
                            Price = 25m,
                        ...
                        new
                        {
                            Id = new Guid("3be95343-27a0-441f-98e5-7babe08e4cbe"),
                            AuthorID = new Guid("8c8bd426-2974-4bad-aa33-0e045ca86a54"),
                            Price = 65m,
                        ...
                        new
                        {
                            Id = new Guid("8c4c0fa4-8f2c-4144-9826-9d5b3fd9bc21"),
                            AuthorID = new Guid("8c8bd426-2974-4bad-aa33-0e045ca86a54"),
                            Price = 150m,
                            SubscriptionTypeID = 1
                        },
                        new
                        {
                            Id = new Guid("ed069b01-922e-444f-96b5-3ac28cf26fa3"),
                            AuthorID = new Guid("47383fe7-f3e1-4d22-8180-5bfaa76955f5"),
                            Price = 25m,
                            SubscriptionTypeID = 1
                        },
                        new
                        {
                            Id = new Guid("16c2c70f-57fb-4249-8d85-42f7d8a30a3e"),
                            AuthorID = new Guid("47383fe7-f3e1-4d22-8180-5bfaa76955f5"),
                            Price = 70m,
                            SubscriptionTypeID = 2
                        },
                        new
                        {
                            Id = new Guid("56aac85a-74df-4917-99db-0d2f2c881488"),
                            AuthorID = new Guid("47383fe7-f3e1-4d22-8180-5bfaa76955f5"),
                            Price = 200m,
                            SubscriptionTypeID = 1
                        },
                        new
                        {
                            Id = new Guid("a3f7111b-5cc3-4143-a389-72a6ad5da4a8"),
                            AuthorID = new Guid("240ae09a-7f04-45e5-ac42-bf5311e1c4a8"),
                            Price = 21m,
                            SubscriptionTypeID = 1
                        },
                        new
                        {
                            Id = new Guid("3a10b313-8b50-4293-81b5-d124d0aab4f4"),
                            AuthorID = new Guid("240ae09a-7f04-45e5-ac42-bf5311e1c4a8"),
                            Price = 55m,
                            SubscriptionTypeID = 2
                        },
                        new
                        {
                            Id = new Guid("fa8ff5d0-8aac-4829-9378-186fc8f23977"),
                            AuthorID = new Guid("240ae09a-7f04-45e5-ac42-bf5311e1c4a8"),
                            Price = 189m,
                            SubscriptionTypeID = 1
                        });
