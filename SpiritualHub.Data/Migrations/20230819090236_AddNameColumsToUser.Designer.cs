...
namespace SpiritualHub.Data.Migrations
{
    ...
    [Migration("20230819090236_AddNameColumsToUser")]
    partial class AddNameColumsToUser
    {
            ...
            modelBuilder.Entity("SpiritualHub.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "020dda7f-bed4-47ba-9c76-472915556522",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAELBkPxzcvkRr3p6V68W0ovYkaCRaCUxUf5/Fwf3FboyUtZgAgDem7i74Vh4K5GRi6w==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "2a39414f-eb4b-4f5d-b47a-799d68d4bb5e",
                            Email = "user@mail.com",
                            EmailConfirmed = false,
                            FirstName = "Martin",
                            LastName = "User",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAENM9lK7q2Fc0KRnNDzfSPZZbJ/m1dvdcYRZNjftuakdjNQ1lYwAbWwG1ju2XIlPVzg==",
                            PhoneNumberConfirmed = false,
                            TwoFactorEnabled = false,
                            UserName = "user"
                        });
            ...
            modelBuilder.Entity("SpiritualHub.Data.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryID = 2,
                            CreatedOn = new DateTime(2023, 8, 19, 9, 2, 35, 930, DateTimeKind.Utc).AddTicks(6204),
                        ...
                        new
                        {
                            ...
                            CategoryID = 5,
                            CreatedOn = new DateTime(2023, 8, 19, 9, 2, 35, 930, DateTimeKind.Utc).AddTicks(6224),
                        ...
                        new
                        {
                            ...
                            CategoryID = 3,
                            CreatedOn = new DateTime(2023, 8, 19, 9, 2, 35, 930, DateTimeKind.Utc).AddTicks(6235),
            ...
            modelBuilder.Entity("SpiritualHub.Data.Models.Subscription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3980ffe4-5541-4a2a-84dd-0e4312f08188"),
                            AuthorID = new Guid("8c8bd426-2974-4bad-aa33-0e045ca86a54"),
                            Price = 25m,
                        ...
                        new
                        {
                            Id = new Guid("b40e462f-60b9-4855-a1ba-661ed90d1880"),
                            AuthorID = new Guid("8c8bd426-2974-4bad-aa33-0e045ca86a54"),
                            Price = 65m,
                        ...
                        new
                        {
                            Id = new Guid("e57d97aa-042b-4722-891d-443c868d1357"),
                            AuthorID = new Guid("8c8bd426-2974-4bad-aa33-0e045ca86a54"),
                            Price = 150m,
                        ...
                        new
                        {
                            Id = new Guid("ce7ea0db-7487-48fd-97a2-325dca81db14"),
                            AuthorID = new Guid("47383fe7-f3e1-4d22-8180-5bfaa76955f5"),
                            Price = 25m,
                            SubscriptionTypeID = 1
                        },
                        new
                        {
                            Id = new Guid("58b090ab-23c9-4771-8077-96455ad7be69"),
                            AuthorID = new Guid("47383fe7-f3e1-4d22-8180-5bfaa76955f5"),
                            Price = 70m,
                            SubscriptionTypeID = 2
                        },
                        new
                        {
                            Id = new Guid("0a96bebf-0f1a-42bd-b0af-a27371c2f63e"),
                            AuthorID = new Guid("47383fe7-f3e1-4d22-8180-5bfaa76955f5"),
                            Price = 200m,
                            SubscriptionTypeID = 3
                        },
                        new
                        {
                            Id = new Guid("830666b5-1a9d-4a43-a5d7-1ce00c86771c"),
                            AuthorID = new Guid("240ae09a-7f04-45e5-ac42-bf5311e1c4a8"),
                            Price = 21m,
                            SubscriptionTypeID = 1
                        },
                        new
                        {
                            Id = new Guid("03422802-9236-447e-ab41-facd15b37f0d"),
                            AuthorID = new Guid("240ae09a-7f04-45e5-ac42-bf5311e1c4a8"),
                            Price = 55m,
                            SubscriptionTypeID = 2
                        },
                        new
                        {
                            Id = new Guid("375b057a-f95e-40cc-8a1d-faff54615a12"),
                            AuthorID = new Guid("240ae09a-7f04-45e5-ac42-bf5311e1c4a8"),
                            Price = 189m,
                            SubscriptionTypeID = 3
                        });
