...
namespace SpiritualHub.Data.Migrations
{
    ...
    [Migration("20230827193640_EventEntityChange")]
    partial class EventEntityChange
    {
            ...
            modelBuilder.Entity("SpiritualHub.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "caa9ad93-8289-46f5-ba22-56efd4abb410",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEJ+Lp3t9g/iiY/OPUO/k+3nNB0QpCpGuYz4S3RAB+olKNvm3+xRRUs48wdcKToKbFg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "1a0113cb-8971-4cd0-acb9-766a8eb96ee5",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "22cb25b4-9b34-4fd0-89b7-0fefba8a2948",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAELi1fgndhs1kzMy3Pue3O1TUjsXlbPHhcBKka9dOI4o/ktpcbaARFYE+3+5DNyc4Fg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "629609d8-be76-47e3-912a-10531fed64d5",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "ede91845-add6-4351-a528-75d0551cb56b",
                            Email = "user@mail.com",
                            EmailConfirmed = false,
                            FirstName = "Martin",
                            LastName = "User",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEFe1jeDB3raRG26+sT690b9bhWGXosg25GFPuZdnzcjinmHXtEToKXbOOgBPPWFYJQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "90ae48ca-ffa4-4f81-b453-824ad9c33a29",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("SpiritualHub.Data.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryID = 2,
                            CreatedOn = new DateTime(2023, 8, 27, 19, 36, 39, 424, DateTimeKind.Utc).AddTicks(4434),
                        ...
                        new
                        {
                            ...
                            CategoryID = 5,
                            CreatedOn = new DateTime(2023, 8, 27, 19, 36, 39, 424, DateTimeKind.Utc).AddTicks(4455),
                        ...
                        new
                        {
                            ...
                            CategoryID = 3,
                            CreatedOn = new DateTime(2023, 8, 27, 19, 36, 39, 424, DateTimeKind.Utc).AddTicks(4463),
            ...
            modelBuilder.Entity("SpiritualHub.Data.Models.Subscription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b094f677-3b9b-4c98-b825-879048418178"),
                            AuthorID = new Guid("8c8bd426-2974-4bad-aa33-0e045ca86a54"),
                            Price = 25m,
                        ...
                        new
                        {
                            Id = new Guid("3009ac6f-6fcb-477d-9516-205f325b9244"),
                            AuthorID = new Guid("8c8bd426-2974-4bad-aa33-0e045ca86a54"),
                            Price = 65m,
                        ...
                        new
                        {
                            Id = new Guid("050ca3d0-7087-45af-a68d-5d814f73f604"),
                            AuthorID = new Guid("8c8bd426-2974-4bad-aa33-0e045ca86a54"),
                            Price = 150m,
                        ...
                        new
                        {
                            Id = new Guid("dad6db19-d97a-41c5-84d6-fc518a5a873f"),
                            AuthorID = new Guid("47383fe7-f3e1-4d22-8180-5bfaa76955f5"),
                            Price = 25m,
                            SubscriptionTypeID = 1
                        },
                        new
                        {
                            Id = new Guid("30104344-d78c-49a7-8985-1d5ad55069be"),
                            AuthorID = new Guid("47383fe7-f3e1-4d22-8180-5bfaa76955f5"),
                            Price = 70m,
                            SubscriptionTypeID = 2
                        },
                        new
                        {
                            Id = new Guid("b4547b31-354e-453f-8684-f66bfb23fab9"),
                            AuthorID = new Guid("47383fe7-f3e1-4d22-8180-5bfaa76955f5"),
                            Price = 200m,
                            SubscriptionTypeID = 3
                        },
                        new
                        {
                            Id = new Guid("108f6076-da3c-4085-828e-e297713a0a97"),
                            AuthorID = new Guid("240ae09a-7f04-45e5-ac42-bf5311e1c4a8"),
                            Price = 21m,
                            SubscriptionTypeID = 1
                        },
                        new
                        {
                            Id = new Guid("43b40f97-7b8f-4aa4-8e4b-34f5231db710"),
                            AuthorID = new Guid("240ae09a-7f04-45e5-ac42-bf5311e1c4a8"),
                            Price = 55m,
                            SubscriptionTypeID = 2
                        },
                        new
                        {
                            Id = new Guid("67a9f2d4-f513-4af2-a09b-93ef70a7dca9"),
                            AuthorID = new Guid("240ae09a-7f04-45e5-ac42-bf5311e1c4a8"),
                            Price = 189m,
                            SubscriptionTypeID = 3
                        });
