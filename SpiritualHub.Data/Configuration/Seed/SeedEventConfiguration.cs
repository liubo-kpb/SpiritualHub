...
public class SeedEventConfiguration : IEntitySeedConfiguration<Event>
{
    ...
    public Event[] GenerateEntities()
    {
        ...
        e = new Event()
        {
            ...
            StartDateTime = new DateTime(2500, 08, 26, 14, 30, 00),
            EndDateTime = new DateTime(2500, 08, 26, 15, 30, 00),
            IsOnline = true,
            CategoryID = 2,
        ...
        e = new Event()
        {
            ...
            Price = 199,
            CreatedOn = DateTime.UtcNow,
            StartDateTime = new DateTime(2500, 09, 26, 18, 30, 00),
            EndDateTime = new DateTime(2500, 09, 26, 22, 00, 00),
            IsOnline = false,
        ...
        e = new Event()
        {
            ...
            Price = 144,
            CreatedOn = DateTime.UtcNow,
            StartDateTime = new DateTime(2500, 09, 02, 09, 00, 00),
            EndDateTime = new DateTime(2500, 09, 03, 18, 00, 00),
            IsOnline = true,
