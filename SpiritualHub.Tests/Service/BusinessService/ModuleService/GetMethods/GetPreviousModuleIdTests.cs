...
public class GetPreviousModuleIdTests : MockConfiguration
{
    [Test]
    public void WhenModuleIsActive()
    {
        ...
        var module = course.Modules.First(m => m.Number == 3);
        ...
        // Act
        var result = _moduleService.GetPreviousModuleId(moduleViewModel, false);
    ...
    public void WhenSecondModuleIsInactive()
    {
        ...
        var expectedId = course.Modules.First(m => m.Number == 1).Id.ToString();
    ...
    public void WhenSeconModuleIsInactive_ButCanAccess()
    {
        ...
        // Act
        var result = _moduleService.GetPreviousModuleId(moduleViewModel, true);
